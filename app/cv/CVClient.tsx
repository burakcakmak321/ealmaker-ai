      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-[0_4px_24px_-4px_rgba(0,0,0,.08)] sm:p-8">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            >
              {yukleniyor ? "CV oluşturuluyor…" : "CV taslağı oluştur"}
            </button>
            <button
              type="button"
              onClick={handlePrint}
              className="w-full rounded-xl border border-slate-200 bg-white py-4 font-semibold text-slate-700 transition hover:border-brand-200 hover:text-brand-700"
            >
              Yazdır / PDF
            </button>
          </div>
